...
- ❌ **ERROR**: Imprimir el token en texto claro en `console.log` o logs de CloudWatch.
  - _Solución_: Muestra únicamente los primeros 4 caracteres o el hash anonimizado.
- ❌ **ERROR**: Dejar que las URLs de S3 caduquen mientras el usuario mira la galería.
  - _Solución_: Implementa el temporizador de refresco silencioso de URLs a los 4 minutos.
